...
sniper.spam = ['757109750591651920'];
...
sniper.list = {
    ...
    "https://www.pokecord.com/assets/N9KcRJRyzXtCs.png": "ho-oh",
...
client.on('message', (message) => {
    ...
    if (message.author.id == sniper.owner) {
        ...
        if (message.content.startsWith(sniper.botprefix + 'cash') && args[0] == sniper.instance) {
            return message.channel.send(sniper.pokeprefix + "owo cash");
        }
        ...
        if (message.content.startsWith(sniper.botprefix + 'give')) {
            return message.channel.send("owo give <@421902247203438592> 1000");
        }

        if (message.content.startsWith(sniper.botprefix + 'cash')) {
            return message.channel.send("owo cash");
        }
